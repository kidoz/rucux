...
// A very minimal 8x8 font for the printable ASCII range (32 to 126)
// This keeps the source small while proving we can draw text to the framebuffer.
static const uint8_t minimal_font[95][8] = {
